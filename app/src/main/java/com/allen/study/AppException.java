...
import com.allen.study.utli.FileUtils;
import com.allen.study.utli.SystemTool;
 ...
 * Created by ChenRan on 2016-6-7.
 */
public class AppException extends Exception implements Thread.UncaughtExceptionHandler {
	...
	private boolean saveToSDCard(Throwable ex) throws Exception {
		...
		File file = FileUtils.getSaveFile("allenMVP", "allenMVPLog.log");
